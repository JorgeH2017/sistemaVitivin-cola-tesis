function validarCliente() {
    var dni, nombres, apellidos, telefono, correo, direccion;
    dni = document.getElementById("txtrutcliente").value;
    nombres = document.getElementById("txtnombrecliente").value;
    apellidos = document.getElementById("txtapellidocliente").value;
    telefono = document.getElementById("txttelefonocliente").value;
    correo = document.getElementById("txtcorreocliente").value;
    direccion = document.getElementById("txtdireccioncliente").value;
    if (dni.length === 0 || dni === null || /^\s+$/.test(dni)) {
        alert("Debes escribir un dni");
        return false;
    }
    valor = document.getElementById("txtrutcliente").value;
