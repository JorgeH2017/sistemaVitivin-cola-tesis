function validarSocio() {
    ...
    dni = document.getElementById("txtrutsocio").value;
    nombres = document.getElementById("txtnombresocio").value;
    apellidos = document.getElementById("txtapellidossocio").value;
    telefono = document.getElementById("txttelefonosocio").value;
    correo = document.getElementById("txtcorreosocio").value;
    direccion = document.getElementById("txtdireccionsocio").value;

    if (dni.length === 0 || dni === null || /^\s+$/.test(dni)) {
        alert("Debes escribir un dni");
        return false;
    }
    valor = document.getElementById("txtrutsocio").value;
