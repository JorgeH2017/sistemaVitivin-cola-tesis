        ...
        <div class="container-fluid">
            ...
            <form id="form1" name="form1" method="post" action="listarstockvino.php">
                ...
                <table class="table table-bordered">
                    ...
                    <th width="143"><center><span>Modificar stock </span></center></th>
                    </tr>
                    ...
                    if ($num == 0) {
                        ...
                        while ($fila = mysqli_fetch_array($res)) {
                            ...
                            <tr>
                                ...
                                <td><span><center><strong><a href="modificarstockvino.php?idvino=<?php echo base64_encode($fila["id_vino"]); ?>" class="Estilo5">Modificar</a></strong></center></span></td>
                            </tr>
                            <?php
                        }
                    }
