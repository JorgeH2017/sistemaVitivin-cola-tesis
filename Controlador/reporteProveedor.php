...
class mipdfProveedor extends TCPDF {
...
$pdf = new mipdfProveedor('', 'mm', 'Letter', true, 'UTF-8', false);
...
$pdf->MultiCell(40, 6, 'Proveedores', 1, 'C', 0, 1, '', '', true);
...
$resul = $objProveedor->listarProveedor();
while ($row = mysqli_fetch_assoc($resul)) {

    $pdf->SetFont('times', '', 10);
    $pdf->MultiCell(20, 20, $row["rut_proveedor"], 1, 'C', 0, 0);
    $pdf->MultiCell(40, 20, $row["nombre_proveedor"], 1, 'C', 0, 0);
    $pdf->MultiCell(40, 20, $row["apellidos_proveedor"], 1, 'C', 0, 0);
    $pdf->MultiCell(30, 20, $row["telefono_proveedor"], 1, 'C', 0, 0);
    $pdf->MultiCell(40, 20, $row["direccion_proveedor"], 1, 'C', 0, 1);
}
