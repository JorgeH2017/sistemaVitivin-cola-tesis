...
class mipdfCliente extends TCPDF {
...
$pdf = new mipdfCliente('L', 'mm', 'Letter', true, 'UTF-8', false);
...
$pdf->MultiCell(40, 6, 'Clientes', 1, 'C', 0, 1, '', '', true);
...
$resul = $objCliente->listarCliente();
while ($row = mysqli_fetch_assoc($resul)) {

    $pdf->SetFont('times', '', 10);
    $pdf->MultiCell(20, 20, $row["rut_cliente"], 1, 'C', 0, 0);
    $pdf->MultiCell(40, 20, $row["nombre_cliente"], 1, 'C', 0, 0);
    $pdf->MultiCell(40, 20, $row["apellidos_cliente"], 1, 'C', 0, 0);
    $pdf->MultiCell(30, 20, $row["telefono_cliente"], 1, 'C', 0, 0);
    $pdf->MultiCell(40, 20, $row["correo_cliente"], 1, 'C', 0, 0);
    $pdf->MultiCell(40, 20, $row["direccion_cliente"], 1, 'C', 0, 1);
}
